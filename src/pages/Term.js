  ...
  return (
    <div>
      ...
      <MDBContainer fluid className="my-5">
          ...
          <MDBCol md="10">
            <MDBCard className="p-4">
              <MDBCardBody>
                ...
                <p>
                  Welcome to Homeodesk! These terms and conditions outline the
                  rules and regulations for the use of Homeodesk's Website,
                  located at www.homeodesk.com. By accessing this website, we
                  assume you accept these terms and conditions. Do not continue
                  to use Homeodesk if you do not agree to take all of the terms
        ...
        <br></br>
        All terms and conditions, policies and notices prefer to the offer, acceptance and consideration of payment necessary to
        ...
        Homeodesk, you agreed to use cookies in agreement with the Homeodesk's
        Privacy Policy. Most interactive websites use cookies to let us retrieve
        the user's details for each visit. 
        <br></br>
        The Cookies are used by our website to enable the functionality of certain areas to make it easier for people
        visiting our website. Some of our affiliate/advertising partners may
        also use cookies. License Unless otherwise stated, Homeodesk and/or its
        licensors own the intellectual property rights for all material on
        Homeodesk. All intellectual property rights are reserved. You may access
        this from Homeodesk for your own personal use subjected to restrictions
        set in these terms and conditions. You must not: Republish material from
        Homeodesk Sell, rent or sub-license material from Homeodesk Reproduce,
        duplicate or copy material from Homeodesk Redistribute content from
        Homeodesk This Agreement shall begin on the date hereof. Our Terms and
        Conditions were created with the help of the Free Terms and Conditions
        Generator. Parts of this website offer an opportunity for users to post
        and exchange opinions and information in certain areas of the website.
        Homeodesk does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Homeodesk,its agents and/or affiliates. 
        <br></br>
        Comments reflect the views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, Homeodesk shall not be liable
        ...
        of the Comments on this website. Homeodesk reserves the right to monitor
        ...
        Homeodesk a non-exclusive license to use, reproduce, edit and authorize
        ...
        Homeodesk; and (d) the link is in the context of general resource
        ...
        by sending an e-mail to Homeodesk. Please include your name, your
        ...
        Homeodesk's logo or other artwork will be allowed for linking absent a
        ...
        Liability We shall not be hold responsible for any content that appears
        on your Website. You agree to protect and defend us against all claims
        that is rising on your Website. No link(s) should appear on any Website
